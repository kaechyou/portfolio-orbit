...
export function ContactCard({ onClose, clickOrigin }: ContactCardProps) {
  ...
  const contacts = [
    {
      ...
      value: "gne@jetthoughts.com",
      href: "mailto:gne@jetthoughts.com",
      icon: (
    ...
    },
    {
      id: "linkedin",
      label: "LinkedIn",
      value: "linkedin.com/in/ekaterina-gnedenko",
      href: "https://linkedin.com/in/ekaterina-gnedenko",
      icon: (
        <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
